...
await pool.query(`
  ...
  -- Certificado del facturador ShopCommerce: archivo cifrado en uploads/ y contraseña cifrada (base64).
  ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS certificado_path TEXT;
  ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS certificado_password_enc TEXT;
